      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography level="title-lg">
              Inver<span style={{ color: 'red' }}>Red</span>
            </Typography>
          </Box>
          <ColorSchemeToggle />
        </Box>
          ...
          <Stack gap={4} sx={{ mb: 2 }}>
            <Stack gap={1}>
              ...
              <Typography level="body-sm">
                ¿Sos nuevo?{' '}
                <Link href="/registro" level="title-sm">
                  ¡Registrate!
                </Link>
              </Typography>
            </Stack>
            ...
            >
              ...
              <Stack gap={4} sx={{ mt: 2 }}>
                ...
                >
                  ...
                  <Link level="title-sm" href="/recuperar-contrasena">
        ...
        <Box component="footer" sx={{ py: 3 }}>
          <Typography level="body-xs" textAlign="center">
            © Grupo 5 SIPI - Miércoles mañana {new Date().getFullYear()}, 2° cuatrimestre
          </Typography>
        </Box>
      </Box>
    </Box>
