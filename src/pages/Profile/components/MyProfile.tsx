    ...
    session && (
      ...
      >
        <Tabs defaultValue={0} sx={{ bgcolor: 'transparent' }}>
          ...
          >
            <FormLabel sx={{ display: { xs: 'none', sm: 'block' } }}>Nombre</FormLabel>
            <Box sx={{ display: { xs: 'contents', sm: 'flex' }, gap: 2 }}>
              <FormControl sx={{ flex: 1 }}>
                <FormLabel sx={{ display: { sm: 'none' } }}>First name</FormLabel>
                <Input placeholder="Nombre" defaultValue={session?.name?.split(' ')[0] || ''} />
              </FormControl>
              <FormControl sx={{ flex: 1 }}>
                <FormLabel sx={{ display: { sm: 'none' } }}>Last name</FormLabel>
                <Input placeholder="Apellido/s" defaultValue={session?.name?.split(' ')[1] || ''} />
              </FormControl>
            </Box>
            ...
            >
              <Avatar size="lg" src={session.avatar} sx={{ '--Avatar-size': '64px' }} />
              <DropZone />
            </Box>
            <Divider role="presentation" />
            <FormControl sx={{ display: { sm: 'contents' } }}>
              <div>
                ...
                <FormHelperText>Destacate en pocas palabras.</FormHelperText>
              </div>
              <Input
                sx={{ mt: 1.5 }}
                defaultValue={session.description}
                placeholder="Desarrollador, inversor, estudiante, etcétera..."
              />
            </FormControl>
            <Divider role="presentation" />
            ...
            <div>
              ...
              <FormHelperText>Tú lugar para explayarte.</FormHelperText>
            </div>
            <div>
              <Textarea minRows={4} placeholder="" />
            </div>
